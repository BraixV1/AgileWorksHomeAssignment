    ...
    return (
        <form onSubmit={handleSubmit(submitHandler)}>
            ...
            <div className="form-group">
                ...
                <input {...register('hasToBeDoneAtDt')}
                       defaultValue={defaultValues.hasToBeDoneAtDt instanceof Date ? defaultValues.hasToBeDoneAtDt.toISOString() : defaultValues.hasToBeDoneAtDt}
                       className="form-control" type="datetime-local" id="hasToBeDoneAtDt"/>
                <span className="text-danger"></span>
            </div>
